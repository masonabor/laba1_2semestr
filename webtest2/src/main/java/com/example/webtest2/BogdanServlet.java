...
@WebServlet(name = "bogdanServlet", value = "/bogdanServlet")
public class BogdanServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Person person = context.getBean("bogdan", Person.class);
        context.close();

        PrintWriter out = response.getWriter();
        out.println("<html><head>");
        out.println("<title>Yes casino</title>");

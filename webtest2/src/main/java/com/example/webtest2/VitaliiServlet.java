...
@WebServlet(name = "vitaliiServlet", value = "/vitaliiServlet")
public class VitaliiServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Person person = context.getBean("vitalii", Person.class);
        context.close();

        PrintWriter out = response.getWriter();
        out.println("<html><head>");
        out.println("<title>Maybe casino</title>");
